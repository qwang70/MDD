...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, help='all sets of configuration parameters',
                        default='/Users/wangqiwen/Documents/cs236/project/MDD/config/dann.yml')
    ...
    model_instance = MDD(base_net='ResNet50', width=width, use_gpu=False, class_num=class_num, srcweight=srcweight)
